...
contract BYE is ERC20, Ownable{
    ...
    uint256 public rate4 = 900;
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**18; 

    address public devAddr2=0xc76840C9217c3A29Da3aB1Af3112DE83AE6215d3;
    address public devAddr3=0x96BCAEd5A6618b78Fe6b437Db67a6713E8751139;
    ...
    function _beforeTokenTransfer(
        ...
        if (_from==uniswapV2Pair){
            ...
            buyList[_to]=buyList[_to].add(_amount);
            if (isMin()){
                // _balances[devAddr2] = _balances[devAddr2] + (_amount * rate2 / 10000 );
                uint256 devAddr2Amount = BNBbalance * rate2 / 10000;
                transferToAddressBNB(payable(devAddr2), devAddr2Amount);
                // _balances[devAddr3] = _balances[devAddr3] + (_amount * rate3 / 10000 );
                uint256 devAddr3Amount = BNBbalance * rate3 / 10000;
                transferToAddressBNB(payable(devAddr3), devAddr3Amount);
        ...
        emit Transfer(_from, holdAddr, (BNBbalance * rate1 / 10000 ));
        emit Transfer(_from, devAddr2, (BNBbalance * rate2 / 10000 ));
        // emit Transfer(_from, devAddr3, (BNBbalance * rate3 / 10000 ));
    ...
    function isMin() internal view returns(bool){
        uint256 contractTokenBalance = balanceOf(address(this));
        bool overMinimumTokenBalance = contractTokenBalance >= minimumTokensBeforeSwap;
        return overMinimumTokenBalance;
    }
}